...
/* Generated from ../O.Common/hello1.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_te, *pvar_dset_devAoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAiSoftCallback", "devTimestampAI", "devAiGeneralTime", "te",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devTimestampAI, pvar_dset_devAiGeneralTime, pvar_dset_te,
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    pvar_func_dbndInitialize, pvar_func_rsrvRegistrar,
...
int hello1_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/yangye16/IOC/helloworld1";
...
/* hello1_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"hello1_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    hello1_registerRecordDeviceDriver(*iocshPpdbbase);
}
